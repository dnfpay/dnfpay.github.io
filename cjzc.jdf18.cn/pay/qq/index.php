...
<head>
    ...
    <link rel="alternate icon" type="/css/wechat_pay.css" href="/img/use_2.png">
    <link rel="apple-touch-icon-precomposed" href="/img/use_2.png">
    <title>支付宝扫码支付</title>
        ...
        <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
            <div data-role="qrPayImg" class="qrcode-img-area">
                <div style="position: relative;display: inline-block;">
                    <img id='qrcode' alt="加载中..." width="210" height="210" src="/img/qq.jpg" style="display: block;">
  </div>
            </div>
        </div>
