...
<head>
    ...
    <link rel="alternate icon" type="image/png" href="img/use_3.png">
    <link rel="apple-touch-icon-precomposed" href="img/use_3.png">
    <title>微信扫码支付</title>
        ...
        <div class="qrcode-img-wrapper" data-role="qrPayImgWrapper">
            <div data-role="qrPayImg" class="qrcode-img-area">
                <div style="position: relative;display: inline-block;">
                    <img id='qrcode' alt="加载中..." width="210" height="210" src="/img/wx.jpg" style="display: block;">
                </div>
            </div>
        </div>
